...
async function main() {
  ...
  await writePng(drawIcon(192, { safeZonePadding: 0.16 }), path.join(outDir, 'icon-192.png'))
  await writePng(drawIcon(512, { safeZonePadding: 0.16 }), path.join(outDir, 'icon-512.png'))
