  ...
  return (
    <Wrapper
      ...
      className={cn(
        ...
        onClick &&
          "transition-colors duration-fast hover:bg-neutral-100 dark:hover:bg-neutral-800",
      )}
    >
      ...
      <div className="flex items-center justify-between text-body-sm tabular-nums text-text-secondary">
        <span>
          ₹{status.spent.toLocaleString("en-IN")} of ₹
          {status.allocated.toLocaleString("en-IN")}
        </span>
