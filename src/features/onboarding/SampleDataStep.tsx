    ...
    <div className="flex flex-col items-center gap-24 text-center">
      ...
      <label
        className={cn(
          ...
          sampleDataRequested ? 'border-income bg-income-subtle' : 'border-border bg-surface-card'
        )}
      >
        <input
          type="checkbox"
        ...
        <span className="text-body-sm text-text-primary">
          Load sample data so I can explore the app (arrives once Transactions is built in Phase 1)
        </span>
      </label>
    </div>
  )
